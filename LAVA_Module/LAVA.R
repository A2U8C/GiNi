...
# save the output
write.table(do.call(rbind,u), paste0(out.fname, "_", i, ".univ.lava"), row.names=F,quote=F,col.names=T)
write.table(do.call(rbind,b), paste0(out.fname, "_", i, ".bivar.lava"), row.names=F,quote=F,col.names=T)
