...
def CAUSE_run(input_trait:str, Enigma:str, bfile:str, input_trait_cols:str):
    ...
    r_command=f'Rscript /ifs/loni/faculty/njahansh/nerds/ankush/GiNi_post_GWAS_processing/CAUSE_Module/Cause.R "{input_trait}" "{Enigma}" "{bfile}" "{input_trait_cols}" "{trait_name}__{Enigma_trait}" "{output_folder}"'
